...
const STORYBOARD_SYSTEM =
  ...
  `At most 6 scenes and 8 shots per scene — treat that as a hard ceiling, not a target: use the FEWEST shots that tell the story; most ideas need far fewer. Do not pad. ` +
