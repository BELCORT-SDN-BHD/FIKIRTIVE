...
// FSE-204 —— 付费前尺寸闸的唯一判定,四入口(画布确认卡 / Library 动作 / Otto 主动 /
// 分镜挂图)共用同一次调用(`gen-actions.ts` 的 `startGen` 是它们共同的建单+预扣权威)。
export { assertPrePaymentReferenceSizeGate } from "./skills/reference-upscale-gate.js";
