...
describe("registry", () => {
  it("collects all fifty-eight skills", () => {
    const names = allSkills.map((s) => s.name).sort();
    expect(names).toEqual(["approveScheduledPost", "buildSegment", "cancelScheduledPost", "deleteReferenceVariant", "describeRefs", "draftWorkflows", "editScheduledPost", "editStoryboard", "generate", "generateReferences", "importMedia", "ingestProduct", "list-meta-pages", "listChannelScopes", "listPublishTargets", "listScheduledPosts", "lookupProducts", "manageBrandMemory", "manageCanvas", "manageContacts", "manageEntities", "manageLibrary", "manageMedia", "manageProjects", "meta-ad-performance", "meta-expert", "meta-insights", "meta-list-objects", "planCampaign", "prepareStoryboardVideos", "propose", "propose-ad-build", "propose-meta-action", "proposeIdeas", "proposePack", "proposeResearch", "proposeStoryboard", "readCampaigns", "readContacts", "readSegments", "readSpending", "readWorkflows", "recallStoreKnowledge", "recommendTemplates", "rememberBrandFact", "renderVideo", "researchWeb", "runFactoryBatch", "saveCustomerSegment", "saveOffer", "saveProduct", "schedulePosts", "seedancePrompt", "seedreamPrompt", "setTitle", "sharePostPreview", "suggestPostTimes", "updateBrief"]);
  });
