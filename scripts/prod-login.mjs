...
//   node scripts/prod-login.mjs "<magic-link-url-from-the-email>"
import { chromium } from "playwright";

const url = process.argv[2];
if (!url || !url.startsWith("http")) { console.error("usage: node scripts/prod-login.mjs <magic-link-url>"); process.exit(1); }
