...
//     ./packages/core/node_modules/.bin/tsx scripts/archive/prod-guardian-server-test.mjs
import { interlock } from "../tools/_interlock.mjs";
interlock({ prod: "runs server-side checkCast against the prod Neon DB ($0, reads-only)" });
