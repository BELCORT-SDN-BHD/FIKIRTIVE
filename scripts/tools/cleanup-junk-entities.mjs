 ...
 *
 * USAGE:
 *   DATABASE_URL=<prod-url> node scripts/tools/cleanup-junk-entities.mjs              # dry run (review)
 *   DATABASE_URL=<prod-url> node scripts/tools/cleanup-junk-entities.mjs --apply      # soft-delete
...
interlock({ prod: "reads/soft-deletes entities in the DATABASE_URL database (documented usage: prod)" });
