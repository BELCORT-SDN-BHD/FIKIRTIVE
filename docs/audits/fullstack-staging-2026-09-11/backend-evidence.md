...
> **更正（第 3 轮）**：Founder 2026-09-11T08:40:24Z 已授权（[#1330](https://github.com/BELCORT-SDN-BHD/FIKIRTIVE/issues/1330) 评论第 4 条逐字「A15／A17 的人为失败注入亦授权」），未跑属时间与取舍。上一行「未授权批量开号」的说法不成立；按惯例不改原句，只在此追加更正。`SENTRY_DSN` 那半句不受影响，仍是环境不可验。
