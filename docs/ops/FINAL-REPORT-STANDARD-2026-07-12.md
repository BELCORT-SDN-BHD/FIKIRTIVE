...
- **开篇城市空照图**:12 区地图,每区状态灯(🟢 通电 / 🟡 建成待钥匙-Coming soon)+ 功能数 + 测试数;三行总账(建了多少 / 花了多少 / 剩什么要 founder)。
- **12 章,每章固定七节**:
  1. 这是什么(人话,一段)
  2. 亲手用一遍(真实商家例子 + 截图 ×N,走完整流程)
  3. Otto 替他做同一件事(双模演示——宪法 7 双 100% 是每章必验项)
  4. 对标(诚实三栏:平齐 / 超过 / 未及,点名品类最强者:Canva/Higgsfield、Buffer、Metricool、respond.io、Klaviyo、Salesforce/HubSpot、Zoho、GHL…)
  5. 证据(五关验收:机器闸 / 真浏览器 E2E 录像 / 认知走查 / 关键测试 / 失败恢复演练)
...
一页纸 15-20 步,每步写"你应该看到什么";founder 不需要任何人在场照着走完、无卡点无货不对板 = 验收通过。同时即第一个真实商家的 onboarding 蓝本。

## 语言与语气

给 founder 的一切 = 人话 + 例子 + 生动(工作规矩②);内部代号必带人话对照;诚实优先于漂亮(未及项如实写)。
