...
> **基线**：main@`1b1414d9`（含 B0 发布契约 #240）。矩阵签署件为界：`docs/archive/route-b/matrix/08-B8.md` 行 B0-63~B0-67。
...
| 矩阵签署件 B0-63~67 | `docs/archive/route-b/matrix/08-B8.md:19-23` | 五能力行 + 批准来源 + 宪法 8 分离闸 | §一映射 |
