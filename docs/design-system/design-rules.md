...
- **Segmented** (reference: Schedule Plan/Calendar/Queue; recipe `.al-seg`): `--card` + 1px `--border`, radius 10, p 2; item h 30, radius 8, px 12, 12/600; active `--secondary`. 2–5 single-word items; never URL-routed. Binary view toggles use this recipe, not two ghost buttons.
...
**V5. Money copy — the law: credits always, never dollars** (founder decision 2026-06-26; the $ conversion is never surfaced). Always through `formatCredits(n)` / `creditsLabel(n)`. The spend arc, one phrasing per stage: ① estimate "~20 credits now" / "About 20 credits" ② quote pending: button disabled, "checking exact cost" ③ reveal "Cost: 20 credits. No charge until you confirm." ④ ask "Generate this video for 20 credits? This will spend real credits." ⑤ commit **"Confirm generate · 20 credits"** — the button IS the receipt; always exact, never "~" ⑥ in flight "Generating…" ⑦ done "✓ You approved this. It used 20 credits." ⑧ failed+refunded "You weren't charged. Try again."
