...
| 2026-07-07 | v2.8 解读边界附则入宪(第二章末):六句澄清(豁免只管 Otto 半边/租户之间 vs 平台侧/实时=秒级/开发花费 vs routine 预算/webhook 非操作面/credits-only 限用户面),源自措辞审计 7 条(B1 已由 v2.7 处理)+ 回填 v2.7 批准列(founder:"照你说的做") | 待 founder 终审合并 |
