...
| E4-16 | 平台可插拔（adapter 缝） | n/a | n/a | 蓝图扩展缝——**现状降准**（A03）：渠道分发今为闭集触点 5 处（含排期 UI，v0.3） | **B4 施工验收=触点收敛为登记式**（契约8）；X 接入即活体验证 | B4-REPORT §⑩ |
