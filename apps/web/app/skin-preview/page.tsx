...
export default async function SkinPreviewPage({
  ...
  const analytics: AnalyticsData = {
    ...
    range: "30d",
    kpis: [
      { label: "Reach", values: ["48.2K"], unknownCurrencyValue: null, delta: { dir: "up", text: "▲ 18%" } },
      { label: "Engagement", values: ["3,140"], unknownCurrencyValue: null, delta: { dir: "down", text: "▼ 6%" } },
      { label: "Spend", values: ["—"], unknownCurrencyValue: null, delta: null },
      { label: "Sales (est.)", values: ["MYR 2,140"], unknownCurrencyValue: null, delta: { dir: "up", text: "▲ 24%" } },
    ],
