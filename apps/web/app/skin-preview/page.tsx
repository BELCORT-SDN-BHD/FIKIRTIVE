...
export default async function SkinPreviewPage({
  ...
  const analytics: AnalyticsData = {
    ...
    range: "30d",
    kpis: [
      { label: "Reach", values: [{ text: "48.2K", currency: null, accountName: null }], delta: { dir: "up", text: "▲ 18%" } },
      { label: "Engagement", values: [{ text: "3,140", currency: null, accountName: null }], delta: { dir: "down", text: "▼ 6%" } },
      { label: "Spend", values: [{ text: "—", currency: null, accountName: null }], delta: null },
      { label: "Sales (est.)", values: [{ text: "MYR 2,140", currency: "MYR", accountName: null }], delta: { dir: "up", text: "▲ 24%" } },
    ],
