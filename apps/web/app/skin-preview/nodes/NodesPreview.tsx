...
const nodes: Node[] = [
  {
    ...
    type: "image",
    position: { x: 60, y: 80 },
    data: { status: "done", url: "https://picsum.photos/seed/cvi1/360/240", prompt: "sunglasses", onAnimate: noop, onDelete: noop, onOpenDetail: noop },
  ...
  },
  {
    ...
    type: "image",
    position: { x: 420, y: 80 },
    data: { status: "pending", onAnimate: noop, onDelete: noop },
  ...
  },
  {
    ...
    type: "video",
    position: { x: 60, y: 360 },
    data: { status: "pending", onDelete: noop },
  ...
  },
  {
    ...
    data: { text: "Cozy autumn vibes, warm light", onChange: noop, onDelete: noop },
