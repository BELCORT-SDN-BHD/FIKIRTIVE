export default function CrmTemplatesLoading() {
  return (
    <main className="min-h-dvh bg-background px-4 py-8 text-foreground sm:px-6 lg:px-8">
      <div className="mx-auto max-w-6xl animate-pulse">
        ...
        <div className="mt-8 h-32 rounded-[var(--radius-card)] border border-border bg-card" />
        <div className="mt-5 grid gap-3">
          <div className="h-24 rounded-[var(--radius-card)] border border-border bg-card" />
          <div className="h-24 rounded-[var(--radius-card)] border border-border bg-card" />
        </div>
        <span className="sr-only">Loading message templates</span>
      </div>
    </main>
  );
}
