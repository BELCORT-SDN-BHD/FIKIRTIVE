  ...
  return (
    <main className="min-h-dvh bg-background px-4 py-10 text-foreground sm:px-6">
      <section className="mx-auto max-w-xl rounded-[var(--radius-card)] border border-border bg-card p-6 shadow-[var(--shadow-sm)] sm:p-8">
        ...
        <h1 className="mt-2 text-2xl font-semibold tracking-tight">Delivery reports could not load</h1>
        <p className="mt-3 text-sm leading-6 text-muted-foreground">
          Nothing was changed. Retry the owner-scoped read, or return to broadcasts.
        </p>
        {error.digest ? (
        ...
        <div className="mt-6 flex flex-wrap gap-3">
          ...
          <Button asChild variant="secondary"><Link href="/crm/broadcasts"><ArrowLeft />Back to broadcasts</Link></Button>
        </div>
      </section>
    </main>
  );
