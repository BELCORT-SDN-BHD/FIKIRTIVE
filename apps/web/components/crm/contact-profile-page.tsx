      ...
      <div className="mx-auto max-w-7xl">
        <header className="border-b border-border pb-7">
          ...
          <div className="mt-4 flex flex-col gap-4 sm:flex-row sm:items-end sm:justify-between">
            <div>
              <p className="text-xs font-semibold uppercase tracking-[var(--r22-track-caps)] text-brand-strong">CRM · Contact profile</p>
              <h1 className="mt-2 text-3xl font-semibold tracking-[var(--r22-track-display-lg)] sm:text-4xl">{contact.name}</h1>
