        ...
        <section id="rule-file" className="scroll-mt-20 pt-8" aria-labelledby="rule-file-heading">
          ...
          <details className="group mt-5 rounded-[var(--radius-card)] border border-border">
            ...
            <div className="border-t border-border p-5">
              <p className="font-mono text-xs text-muted-foreground">/workflows/{definition.slug}.workflow.yaml · {shortWorkflowId(definition.id)}</p>

              <div className="mt-4 grid grid-cols-[minmax(0,1fr)_340px] gap-5">
