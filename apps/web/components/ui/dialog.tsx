...
/**
 * FIKIRTIVE dialog: 24px radius, white surface, a cool-ink scrim with a soft
 * blur, gentle rise-in. Coral focus ring on the close affordance.
 */
...
function DialogFooter({ className, ...props }: React.ComponentProps<"div">) {
  return <div data-slot="dialog-footer" className={cn("flex justify-end gap-3 pt-2", className)} {...props} />
}
