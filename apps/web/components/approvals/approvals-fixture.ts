...
export const FIXTURE_ITEMS: ApprovalItem[] = [
    ...
    previews: [
      {
        ...
        fit: "Square 1:1 · caption 118 characters",
      },
    ],
    brief: {
  ...
  },
  {
    ...
    group: "today",
    when: "Today 18:00",
    detail: "Instagram, Facebook · 2 of these hold Sat 10:00",
    images: [
    ...
    openLabel: "Open in campaign",
    openHref: "/campaign?fixture=r22",
    consequence: "Schedules 4 posts · held until a channel is connected",
    ...
    previews: [
      {
        ...
        fit: "Portrait 4:5 · first two lines visible before “more”",
      },
      {
        platform: "Facebook",
  ...
  },
  {
    ...
    detail: "Images ×4 · 4 cr each",
    pendingImage: true,
    sources: ["candle scent list"],
    openLabel: "See the credit ledger",
    openHref: "/settings?section=billing&fixture=r22",
    consequence: "Makes 4 images · 16 cr leaves your balance",
    decideBy: "Fri 18:00",
    decideByHours: 30,
    blocker: {
      chip: "Over weekly credit cap",
      why: "The Weekend routine has 8 cr left this week and this batch needs 16 cr, so nothing can be made until the cap or the batch changes.",
      fixContext: "Raise the weekly credit cap for the Weekend routine, or cut this batch to 2 images",
    },
    previews: [
      {
        platform: "Instagram",
        caption: "Four more scent variants of the Deepavali set, same lighting as the first four.",
        fit: "Square 1:1 · nothing is made until this is approved",
      },
    ],
    brief: {
      routine: "Weekend routine · runs Saturday 10:00",
    ...
    timeline: [
      ...
      { id: "i3-t2", label: "Held by the weekly credit cap", when: "Yesterday 21:46", detail: "8 cr left this week, 16 cr needed." },
    ],
  },
  {
    id: "i4",
  ...
  },
  {
    ...
    nextTime: "Sat 09:00",
    detail: "Instagram · 1 post · nothing is generated or spent by this change",
    sources: ["public holidays"],
    openLabel: "Open in schedule",
    openHref: "/schedule?fixture=r22",
    consequence: "Moves 1 scheduled post · nothing is generated or spent",
    decideBy: "Thu 20:00",
    decideByHours: 34,
    previews: [
      {
        platform: "Instagram",
        caption: "Same post, same caption — only the slot moves from Fri 10:00 to Sat 09:00.",
  ...
  },
  {
    ...
    status: "approved",
    when: "Sat 10:00",
    detail: "Instagram · Scheduled · held until a channel is connected",
  ...
  },
  {
    ...
    cost: 0,
    status: "rejected",
    detail: "Instagram · a new version is in Needs review",
    images: ["/fixtures/r22-canvas/art-2.jpg"],
...
/** ⑥ 一串金额的说法,只有这一处 —— 0 cr 不写「0 cr」,那是假精确。 */
