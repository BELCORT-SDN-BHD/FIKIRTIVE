  ...
  return (
    <Dialog open={open} onOpenChange={(next) => next ? onOpenChange(true) : requestClose()}>
      <DialogContent className="r22-brand-voice-flow" showCloseButton={false}>
        ...
        </> : step === "generating" ? <div className="r22-brand-generating" aria-live="polite"><span /><DialogTitle>Generating Brand Voice</DialogTitle><DialogDescription>This step pauses here while approved sources are reviewed. FIKIRTIVE does not show success until analysis finishes.</DialogDescription><article><b>{name}</b><small>Reviewing your sources</small><i /><i /><i /></article></div> : step === "review" ? <>
