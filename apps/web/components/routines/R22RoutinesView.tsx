    ...
    <main className="r22-routines" data-r22-routines>
      ...
      {!readError && view === "configuration" && (
        <>
          ...
          {!readError && !editing && rows.length === 0 && <section className="r22-routines-empty"><Workflow aria-hidden="true" /><b>No routine yet</b><p>A routine is the only thing that lets Otto work on its own — the days and times it posts, what it posts about, and how many credits it may spend in a week. Until you make one, Otto prepares nothing and spends nothing.</p><Button unstyled type="button" onClick={() => openEditor()}>Create routine</Button></section>}
