    ...
    <div className="gb leading-[1.5]" style={{ flex: 1, overflow: "auto", padding: "1.25rem" }}>
      <div style={{ maxWidth: 720, margin: "0 auto" }}>
        ...
        <p className="text-muted-foreground text-[0.875rem]" style={{ margin: "0.25rem 0 1rem" }}>
          Connect Instagram and Facebook so Otto can schedule posts and read results — auto-publish unlocks once Meta approves publishing. Otto never changes an ad on its own — every change needs your approval, and the controls below stay in your hands.
        </p>
