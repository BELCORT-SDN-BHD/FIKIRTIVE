      ...
      <section className="r22-help-contact" aria-labelledby="help-contact-heading">
        ...
        {fixture ? <>
          {supportPhase === "draft" ? <div className="r22-help-support-form">
            ...
            <p>{supportPhase === "error" ? "It did not go through, and nothing was confirmed. Trying again keeps the same request number." : supportPhase === "unknown" ? "Do not send it again. Check this same request number, so a slow confirmation does not create a second one." : supportPhase === "queued" ? "Your request is in. Queued is not the same as a person replying." : supportPhase === "waiting" ? "Your request is open and waiting for a person. Nothing is being made up in the meantime." : "This request was closed after its status was checked."}</p>
