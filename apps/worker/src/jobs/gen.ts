 ...
 *
 * Every failure is swallowed on purpose. This runs after the charge is settled and the clip is
 * committed, so the worst case is "this link of the storyboard needs a first frame generated by
 * hand", which is exactly what happened before this ticket existed.
 */
